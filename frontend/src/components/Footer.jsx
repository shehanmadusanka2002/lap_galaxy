...
function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 py-8 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex items-center gap-4 bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-all">
              <div className="bg-indigo-600 p-3 rounded-full">
                <Truck size={24} />
              </div>
              <div>
                <h4 className="font-bold text-white">Free Shipping</h4>
                <p className="text-sm text-gray-300">On orders over Rs. 50,000</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/5 rounded-lg p-4 hover:bg-white/10 transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Authentic products only</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                  ...
                  <span>+94 112 584 406 / +94 77 123 4567</span>
                </div>
                <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                  <Mail size={18} className="text-purple-400" />
                  <span>info@lapgalaxy.lk</span>
                </div>
                <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="#" className="bg-white/10 hover:bg-blue-600 p-2.5 rounded-lg transition-all transform hover:scale-110">
                    <Facebook size={20} />
                  </a>
                  <a href="#" className="bg-white/10 hover:bg-pink-600 p-2.5 rounded-lg transition-all transform hover:scale-110">
                    <Instagram size={20} />
                  </a>
                  <a href="#" className="bg-white/10 hover:bg-blue-400 p-2.5 rounded-lg transition-all transform hover:scale-110">
                    <Twitter size={20} />
                  </a>
                  <a href="#" className="bg-white/10 hover:bg-blue-700 p-2.5 rounded-lg transition-all transform hover:scale-110">
                    <Linkedin size={20} />
                  </a>
                  <a href="#" className="bg-white/10 hover:bg-red-600 p-2.5 rounded-lg transition-all transform hover:scale-110">
                    <Youtube size={20} />
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              ...
              <span className="hidden md:inline"> | Crafted with ❤️ in Sri Lanka</span>
            </p>
